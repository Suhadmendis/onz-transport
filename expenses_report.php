...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><b>Expenses Report</b></h3>
        </div>
        <form name= "form1" role="form" class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group-sm">
                    ...
                    <a onclick="print_V();" class="btn btn-primary btn-sm" >
                        <span class="glyphicon glyphicon-print"></span> &nbsp; Vehicle
                    </a>
                      <a onclick="print_G();" class="btn btn-primary btn-sm" >
...
<script src="js/expence_report.js"></script>
