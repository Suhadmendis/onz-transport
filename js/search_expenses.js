...
function update_cust_list(stname) {
  ...
  url =
    url + "&customername1=" + document.getElementById("customername1").value;
  url =
    url + "&customername2=" + document.getElementById("customername2").value;
