...
function update_cust_list(stname) {
  ...
  url =
    url + "&customername3=" + document.getElementById("customername3").value;
  url =
    url + "&customername4=" + document.getElementById("customername4").value;
  url =
    url + "&customername5=" + document.getElementById("customername5").value;
